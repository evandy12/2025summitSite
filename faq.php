                       ...
                       <div id="about" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                           <div class="accordion-body">
                               <div class="mb-4">
                                   ...
                                   <p>CARISCA's annual Supply Chain Research Summit is central to our goal of strengthening African supply chain capacity and advancing Africa's supply chain research globally. The fifth annual Supply Chain Research Summit will be held on May 5-7, 2025, in Lagos, Nigeria.</p>
                               </div>
                               <div class="mb-4">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="program" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                ...
                                <div>
                                    <h5>Are the presentations available after the summit?</h5>
                                    <p>Presentation materials will be made available to registered attendees after the summit through our online portal, subject to speaker approval.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="papers" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                ...
                                <div class="mb-4">
                                    <h5>What are the presentation formats?</h5>
                                    <p>Presentations can be either oral presentations (20 minutes) or poster presentations. Specific requirements will be provided in the submission guidelines.</p>
                                </div>
                                <div>
                                    <h5>Will the papers be published?</h5>
                                    <p>Selected papers will be published in the conference proceedings. Outstanding papers may be invited for publication in partner journals.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div id="travel" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                          <div class="accordion-body">
                              <div class="mb-4">
                                  ...
                                  <p>In May, Lagos experiences temperatures between 27-32°C (81-90°F). It's during the rainy season, so we recommend bringing appropriate clothing and an umbrella.</p>
                              </div>
                              <div class="mb-4">
